...
def parse_args(script):
    ...
    parser.add_argument('--n_test_shot', default=5, type=int,
    ...
    parser.add_argument('--models_to_use', '--names-list', nargs='+',
                        default=['miniImageNet', 'caltech256', 'DTD', 'cifar100', 'CUB'], help='pretained model to use')
    ...
    parser.add_argument('--n_support', default=1, type=int,
                        help='Number of support examples (1 for ProtoTransfer/UMTRA)')
    parser.add_argument('--n_query', default=3, type=int,
                        help='Number of query examples (1 for UMTRA, >=1 for ProtoTransfer)')
    parser.add_argument('--no_aug_support', action='store_true',
                        help='Whether to NOT augment the (single!) support example')
    parser.add_argument('--no_aug_query', action='store_true',
                        help='Whether to NOT augment the (single!) query example')
    ...
    if script == 'train':
        ...
        parser.add_argument('--custom_aug', default=None, type=str,
                            help='Dataset specific augmentation')  # for meta-learning methods, each epoch contains 100 episodes
        ...
        parser.add_argument('--proto_init', action='store_true',
                            help='initialize the adapted classifier via distances to prototypes')
