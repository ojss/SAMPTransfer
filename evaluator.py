...
def cli_main():
    ...
    model=PCLROBoW(n_support=1,n_query=3,batch_size=64,lr_decay_step=25000,lr_decay_rate=0.5,feature_extractor=CNN_4Layer(3,64,64),bow_levels=['block4'],bow_extractor_opts={'inv_delta':15,'num_words':8192},bow_predictor_opts={'kappa':5})
...
#                                          bow_extractor_opts={'inv_delta': 15, 'num_words': 4096},
